...
from trained_player_king import trained_player_king
import random
...
player = trained_player_king('Motaz', True)
ai1 = trained_player_king('ai1', False)
ai2 = trained_player_king('ai2', False)
ai3 = trained_player_king('ai3', False)
...
while not end_game:
    ...
    if new_subgame:
        ...
        cards_played, winner,stop_game = play()
        #print('players order: ', players_order)
        ...
        if len(players_order[-1].hand) == 0 or stop_game:
