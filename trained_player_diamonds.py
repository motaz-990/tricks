...
class trained_player_diamonds:
    ...
    def __init__(self, name, trained):
        ...
        # states: 1:['first_diamonds_allowed,'first_diamonds_prohibited],2:['second_same_possible_diamonds','second_same_clear_diamonds','second_different'],
        # 3:['third_same_possible_diamonds','third_same_clear_diamonds',third_different'],4:['fourth_same_possible_diamonds','fourth_same_clear_diamonds',fourth_different']
        #states: { first:{legal:{strong,weak},illegal:{strong,weak}} , second:{match:{1:{diamond,possible},2:{diamond,possible},3:{diamond,possible},
        #different:{strong,weak}}, third ........
        self.first_dic = {0:'legal',1:'illegal'}
        self.state_space = {1:{True:{True:0,False:1},False:{0:2, 1:3, 2:4}},
                            2:{True:{1:{True:5,False:6},2:{True:7,False:8},3:{True:9,False:10}},False:{True:11,False:12}},
                            3:{True:{1:{True:13,False:14},2:{True:15,False:16},3:{True:17,False:18}},False:{True:19,False:20}},
                            4:{True:{1:{True:21,False:22},2:{True:23,False:24},3:{True:25,False:26}},False:{True:27,False:28}}}
        self.state_space_length = 28
